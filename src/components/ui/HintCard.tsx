...
const VARIANTS = {
  teal: {
    container: 'bg-teal-50/60 dark:bg-teal-900/10 border border-teal-200 dark:border-teal-400/20',
  ...
  amber: {
    container: 'bg-amber-50/60 dark:bg-amber-900/10 border border-amber-200 dark:border-amber-400/20',

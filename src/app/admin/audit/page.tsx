...
function roleBadgeColor(role: string | null): string {
  switch (role) {
    ...
    case 'coach':
      return 'bg-teal-50 dark:bg-teal-900/10 text-teal-700 dark:text-teal-300 border-teal-200 dark:border-teal-400/20'
    case 'caregiver':
      return 'bg-amber-50 dark:bg-amber-900/10 text-amber-700 dark:text-amber-300 border-amber-200 dark:border-amber-400/20'
    default:

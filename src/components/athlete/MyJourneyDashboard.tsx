            ...
            <div className="space-y-2">
              {bestRuns.map(run => {
                ...
                return (
                  <div
                    key={run.id}
                    className="bg-amber-50/50 dark:bg-amber-900/10 border border-amber-100 dark:border-amber-400/20 border-l-4 border-l-amber-400 rounded-xl px-4 py-3 flex items-center gap-4 shadow-sm"
                  >
                    {feel && (
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex items-center gap-2 mt-1">
                        {km > 0 ? (
                          <>
                            <div className="flex-1 h-2 bg-amber-100 dark:bg-amber-900/10 rounded-full overflow-hidden">
                              <div
                                className="h-full bg-amber-400 rounded-full"

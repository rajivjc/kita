  ...
  if (sessions.length === 0) {
    return (
      <div className="text-center py-16">
        ...
        <p className="text-base font-semibold text-text-primary mb-1">No sessions logged yet</p>
        <p className="text-sm text-text-muted">Sessions will appear here once you log a run or sync from Strava.</p>
      </div>
    )
  }

        ...
        <div className="mb-2">
          {showNoteInput ? (
            ...
            <button
              ...
              className="w-full bg-teal-50 dark:bg-teal-900/10 hover:bg-teal-100 active:scale-[0.98] border border-teal-200 dark:border-teal-400/20 text-teal-700 dark:text-teal-300 hover:text-teal-800 dark:hover:text-teal-300 rounded-xl py-3.5 text-sm font-semibold transition-all duration-150"
            >
              + Add note
            </button>
          )}

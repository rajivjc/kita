  ...
  return (
    <Link
      ...
      className={`flex items-center gap-4 rounded-xl shadow-sm p-4 hover:shadow-md active:scale-[0.98] transition-all duration-200 ${
        needsAttention
          ? 'bg-amber-50/60 dark:bg-amber-900/10 border border-amber-200/80 dark:border-amber-400/30 hover:border-amber-300'
    ...
    >
      ...
      {photoUrl ? (
        ...
        <div className="relative flex-shrink-0">
          <div className="rounded-full w-12 h-12 bg-teal-50 dark:bg-teal-900/10 flex items-center justify-center text-2xl">
            {avatar}
          </div>
          <span
        ...
        <div className={`rounded-full w-12 h-12 flex items-center justify-center font-semibold text-base flex-shrink-0 ${
          needsAttention ? 'bg-amber-100 dark:bg-amber-900/10 text-amber-700 dark:text-amber-300' : 'bg-teal-50 dark:bg-teal-900/10 text-teal-600 dark:text-teal-300'
        }`}>
          {getInitials(name)}
        </div>
      )}
        ...
        <div className="flex items-center gap-2 mt-0.5">
          ...
          {lastSessionDate ? (
            <>
              ...
              <span className={`text-sm ${needsAttention ? 'text-amber-600 dark:text-amber-300 font-medium' : 'text-text-hint'}`}>
            ...
            <>
              <span className="text-text-hint">·</span>
              <span className="text-sm text-amber-600 dark:text-amber-300 font-medium">No runs yet</span>
            </>
          )}
        </div>
